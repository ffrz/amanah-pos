            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-lg-1 d-flex flex-column justify-content-center order-2"
                        ...
                        <p>{{ config('app.name') }} adalah solusi digital untuk mencatat dan mengelola saldo santri di
                            lingkungan
        ...
        <section class="section about" id="about">
            ...
            <div class="container">
                ...
                <p class="mb-5 text-center">
                    {{ config('app.name') }} dirancang khusus untuk koperasi pesantren, sekolah Islam, dan lingkungan
                    pendidikan
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <p>{{ config('app.name') }} siap diintegrasikan dengan sistem penjualan koperasi
      ...
      <div class="container">
        ...
        <section class="contact section" id="features">
            ...
            <div class="container" data-aos="fade-up">
                <h2 class="text-center">Kenapa Memilih {{ config('app.name') }}?</h2>
        ...
        <div class="container">
            <div class="row text-center" id="contact">
                <div class="col-lg-12 mt-5 text-center">
                    ...
                    <p><strong>Email:</strong> <span>info@shiftech.my.id</span></p>
                </div>
            </div>
            <!--
