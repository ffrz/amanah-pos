...
<body class="index-page">
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-lg-12">
            ...
            <p>Aplikasi koperasi ini digunakan oleh wali santri untuk memantau saldo, mutasi transaksi, tagihan, dan pembayaran yang berkaitan dengan koperasi {{ $company_name }}.</p>
            <p>
  ...
  <footer id="footer" class="footer position-relative">
    <div class="container">
      <div class="row text-center">
        <div class="col-lg-12 mt-5 text-center">
          ...
          <p class="mt-3"><strong>Telepon / WA:</strong> <a href="https://wa.me/{{ $company_phone }}">{{ $company_phone }}</a></p>
    ...
    <div class="copyright container mt-4 text-center">
      <p>Tentang <a href="{{ route('landing-page') }}">{{ env('APP_NAME') }} {{ env('APP_VERSION_STR') }}</a></p>
