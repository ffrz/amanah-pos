...
const title = (!!page.props.data.id ? "Edit" : "Catat") + " Piutang Manual";

// Composable untuk filter dropdown customer
...
const submit = () => {
  ...
  handleSubmit({ form, url: route("admin.customer-ledger.save") });
};
</script>
    ...
    <template #left-button>
      <div class="q-gutter-sm">
        <q-btn
          ...
          flat
          rounded
          @click="$inertia.get(route('admin.customer-ledger.index'))"
        />
      </div>
    </template>
                ...
                <template v-slot:no-option>
                  <q-item>
                    <q-item-section class="text-grey"
                      >Pelanggan tidak ditemukan</q-item-section
                    >
                  </q-item>
                </template>
              </q-select>
