        ...
        <div class="row q-col-gutter-sm ">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <q-item :style="`background-color: #fd8e24`" class="q-pa-none">
              <q-item-section side :style="`background-color: #fd7e14`" class="q-pa-lg q-mr-none text-white">
                <q-icon class="material-filled" name="paid" color="white" size="24px" />
              </q-item-section>
              <q-item-section class=" q-pa-md q-ml-none text-white">
                <q-item-label class="text-white text-weight-bold">
                  Rp. {{ formatNumber($page.props.data.total_finance_account_balance) }}
                </q-item-label>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <q-item :style="`background-color: #dc3545`" class="q-pa-none">
              ...
              <q-item-section class=" q-pa-md q-ml-none text-white">
                <q-item-label class="text-white text-weight-bold">
                  Rp. {{ formatNumber($page.props.data.total_customer_balance) }}
                </q-item-label>
