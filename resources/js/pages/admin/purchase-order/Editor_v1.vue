...
const statuses = createOptions(window.CONSTANTS.PURCHASE_ORDER_STATUSES);
const payment_statuses = createOptions(
  window.CONSTANTS.PURCHASE_ORDER_PAYMENT_STATUSES
);
const delivery_statuses = createOptions(
  window.CONSTANTS.PURCHASE_ORDER_DELIVERY_STATUSES
);
...
const submit = () =>
  handleSubmit({ form, url: route("admin.purchase-order.save") });
</script>
