...
Route::middleware([Auth::class])
    ->group(function () {
        ...
        Route::prefix('reports')->group(function () {
            ...
            Route::get('sales-order', [SalesOrderReportController::class, 'index'])->name('admin.report.sales-order.index');
            Route::get('sales-order/generate', [SalesOrderReportController::class, 'generate'])->name('admin.report.sales-order.generate');
        ...
        Route::middleware([CheckAdminRoutePermission::class])->group(function () {
            ...
            Route::prefix('purchase-orders')->group(function () {
                ...
                Route::get('print/{id}', [PurchaseOrderController::class, 'print'])->name('admin.purchase-order.print');
                // items
            ...
            Route::prefix('purchase-order-returns')->group(function () {
                ...
                Route::get('print/{id}', [PurchaseOrderReturnController::class, 'print'])->name('admin.purchase-order-return.print');
                // items
