...
namespace Modules\Admin\Http\Requests\FinanceTransactionCategory;
...
class SaveRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id' => 'nullable|integer|exists:finance_transaction_categories,id',
            'name' => [
                'required',
                'max:255',
                Rule::unique('finance_transaction_categories', 'name')->ignore($itemId),
            ],
