...
namespace Modules\Admin\Http\Requests\FinanceTransactionTag;
...
class SaveRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id' => 'nullable|integer|exists:finance_transaction_tags,id',
            'name' => [
                'required',
                'max:255',
                Rule::unique('finance_transaction_tags', 'name')->ignore($itemId),
            ],
